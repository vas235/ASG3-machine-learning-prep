...
label define a2_if_lab  .n "Not in universe", add
label define a2_if_lab  .l "Logical skip", add
label define a2_if_lab  .d "Suppressed for confidentiality", add
...
label define k6q08_r_lab  1  "Yes, somewhat concerned"
label define k6q08_r_lab  2  "Yes, very concerned", add
label define k6q08_r_lab  3  "No", add
...
label define tenure_lab  1  "Owned by you or someone in this household with a mortgage or loan?"
...
label define sesplanmo_lab 8 "7 or 8", add
